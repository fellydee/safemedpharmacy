                ...
                <div class="card shadow mb-4">
                  <div class="card-body">
                    <div class="box-body">
                      ...
                      <form class="form" action="sku-process.php" method="post">
                        <div class="form-group">
                          <label>SKU</label>
                          <form action="sku-process.php" method="post">
                            <input type="text" class="form-control" name="sku" value="" placeholder="Search for SKU" required>
                            <input type="submit" value="Enter">
                          </form>
                        </div>
                        <div class="form-group">
                          <label>Brand Name</label>
                          <input type="text" class="form-control" name="brand_name" value="" disabled>
                        </div>
                        <div class="form-group">
                          <label>Supplier</label>
                          <input type="text" class="form-control" name="supplier" value="" disabled>
                        </div>
                        <div class="form-group">
                          <label>Unit of Measurement</label>
                          <input type="text" class="form-control" name="uom" value="" disabled>
                        </div>                        
                        <div class="form-group">
                          <label>Defective Quantity</label>
                          <input type="text" class="form-control" name="defective_qty" value="" disabled>
                        </div>  
                        <div class="form-group">
                          <label>Unit Price</label>
                          <input type="text" class="form-control" name="unit_price" value="" disabled>
                        </div>
                    </div>
                      <!-- /.box-body -->
                  </div>
                  ...
                  <div class="card-body">
                      <div class="box-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="generic_name" value="" disabled>
                        </div>
                         <div class="form-group">
                          <label>Category</label>
                          <input type="text" class="form-control" name="category" value="" disabled>
                        </div>
                        <div class="form-group">
                          <label>Order Quantity</label>
                          <input type="text" class="form-control" name="order_qty" value="" disabled>
                        </div>
                        <div class="form-group">
                          <label>Expiration Date</label>
                          <input type="text" class="form-control" name="expiration_date" value="" disabled>
                        </div>  
                        <div class="form-group">
                          <label>Selling Price</label>
                          <input type="text" class="form-control" name="selling_price" value="" disabled>
                        </div>     
                      </div>
                  </div>
                </div>
